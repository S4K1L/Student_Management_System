...
import 'attendencedropdown1.dart';
...
class _AttendancePageState extends State<AttendancePage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                      buildAttendanceCard(context, index)),
              // ListTile(
            ...
            MaterialPageRoute(builder: (context) => AttendenceDropdownPage1()),(route)=>false)
                      },
  ...
  buildAttendanceCard(BuildContext context, int index) {
    var index2 = index+1;
...
void ResetState() {
  for(int state =0 ; state < attendanceColor.length ; state++){
    attendanceColor[state] = Colors.white;
  }
...
void ChangeColor(List<int> isSelectedList, int index) {
  if (isSelectedList[index] == 1) {
    attendanceColor[index] = Colors.green ;
    // print("changed to : "+ isSelectedList.toString());
  } else {
    if (isSelectedList[index] == 2) {
      attendanceColor[index] = Colors.yellow;
    // print("changed to : "+ isSelectedList.toString());
    } else {
      attendanceColor[index] = Colors.red;
    // print("changed to : "+ isSelectedList.toString());
    }
  }
}
